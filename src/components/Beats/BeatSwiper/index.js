          ...
          <Swiper className="mySwiper">
            ...
            groupedProds.map((slide) => (
              <SwiperSlide className="beat-slide">
                ...
                <h2 className="click-to-view1 no-hover">Click to View</h2>
                ...
                <h2 className="click-to-view2 no-hover">Click to View</h2>
                ...
                <h2 className="click-to-view3 no-hover">Click to View</h2>
